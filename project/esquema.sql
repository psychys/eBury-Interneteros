...
CREATE TABLE DATOS (TIPO_AUTORIZACION VARCHAR NOT NULL, datos_persona_autorizada VARCHAR NOT NULL, datos_empresa INTEGER NOT NULL, PRIMARY KEY (TIPO_AUTORIZACION, datos_persona_autorizada, datos_empresa))
...
CREATE TABLE SALDO (CANTIDAD INTEGER NOT NULL, cuenta INTEGER NOT NULL, n_divisa VARCHAR NOT NULL, PRIMARY KEY (cuenta, n_divisa))
...
CREATE TABLE banco_referencia (nombre_banco VARCHAR NOT NULL, c_ref_iban VARCHAR NOT NULL, PRIMARY KEY (nombre_banco, c_ref_iban))
CREATE TABLE pais_banco (abreviatura_pais VARCHAR NOT NULL, nombre_banco VARCHAR NOT NULL, PRIMARY KEY (abreviatura_pais, nombre_banco))
...
ALTER TABLE DATOS ADD CONSTRAINT FK_DATOS_datos_empresa FOREIGN KEY (datos_empresa) REFERENCES CLIENTE (IDENTIFICADOR)
ALTER TABLE DATOS ADD CONSTRAINT FK_DATOS_datos_persona_autorizada FOREIGN KEY (datos_persona_autorizada) REFERENCES PERSONA_AUTORIZADA (DNI)
...
ALTER TABLE SALDO ADD CONSTRAINT FK_SALDO_cuenta FOREIGN KEY (cuenta) REFERENCES CUENTA_EBURY (N_CUENTA)
ALTER TABLE SALDO ADD CONSTRAINT FK_SALDO_n_divisa FOREIGN KEY (n_divisa) REFERENCES divisa (nombre_divisa)
...
ALTER TABLE banco_referencia ADD CONSTRAINT FK_banco_referencia_nombre_banco FOREIGN KEY (nombre_banco) REFERENCES BANCO (NOMBRE_BANCO)
ALTER TABLE banco_referencia ADD CONSTRAINT FK_banco_referencia_c_ref_iban FOREIGN KEY (c_ref_iban) REFERENCES CUENTA_REFERENCIA (IBAN)
ALTER TABLE pais_banco ADD CONSTRAINT FK_pais_banco_abreviatura_pais FOREIGN KEY (abreviatura_pais) REFERENCES PAIS (ABREVIATURA)
ALTER TABLE pais_banco ADD CONSTRAINT FK_pais_banco_nombre_banco FOREIGN KEY (nombre_banco) REFERENCES BANCO (NOMBRE_BANCO)
